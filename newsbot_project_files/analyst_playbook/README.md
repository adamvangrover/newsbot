...
*   **[Junior Analyst Interactive UI Notebook](../junior_analyst_interactive_ui.ipynb) (`../junior_analyst_interactive_ui.ipynb`):** An interactive Jupyter Notebook designed to guide junior analysts in using the playbook's resources, particularly the LLM prompts, to find, generate, and understand financial insights.
